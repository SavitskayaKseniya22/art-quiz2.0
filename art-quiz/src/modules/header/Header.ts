...
class Header {
  ...
  static content() {
    return `<header class="header-main">
        <h1 data-i18n="header.title">Art Quiz</h1>
        <nav class="nav">
          <a class="nav__home" href="/#" title="Back to home page" data-i18n="[title]header.tips.home" data-disabled="true">
            <i class='bx bx-home-alt'></i>
          </a>
          <button class="nav__cat"  title="Back to category page" data-i18n="[title]header.tips.back" data-disabled="true">
            <i class='bx bxs-widget'></i>
          </button>
          <label class="nav__settings" for="settings__toggle" title="Settings" data-i18n="[title]header.tips.settings">
          <i class='bx bx-cog' ></i>
          </label>
        </nav>
      </header>`;
